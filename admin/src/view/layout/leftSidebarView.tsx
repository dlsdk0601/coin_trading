  ...
  return (
    <aside
      className={classNames(
        "dark:bg-boxdark absolute top-0 left-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear lg:static lg:translate-x-0",
        {
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      ...
                      <Link
                        href="#"
                        className={`group text-bodydark1 hover:bg-graydark dark:hover:bg-meta-4 relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out ${
                      ...
                      <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/public"
                              className={`group text-bodydark2 relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                pathname === "/" && "text-white"
                              }`}
                            >
                              eCommerce
              ...
              <li>
                <Link
                  href={Urls.config.page.url({})}
                  className={classNames("group text-bodydark1 hover:bg-graydark dark:hover:bg-meta-4 relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out", {
                    "bg-graydark dark:bg-meta-4": pathname.includes("config")
                  })}
                >
                    <Settings />
                    설정
